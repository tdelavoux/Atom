class AtomNotificationWraper{
  ...
  constructor(position){
      ...
      this.localConfig = AtomNotificationWraper.globalConfig;
  ...
  insertNotification(elem){
      ...
      if(parseInt(maxElements) && this.element.childElementCount > this.localConfig.maxElements){
...
class AtomNotification {
  ...
  static styles            = {
      commun   : "font-size:14px;font-weight:bold;z-index:99999;padding: 0.7em 1em;border-radius:7px; margin: 0.5em 1em 0.5em auto;overflow:hidden;max-width:600px;width:fit-content;align-self:end;pointer-events:fill;cursor: pointer;",
  ...
  show(){
      ...
      this.wrappers[this.localConfig.alignment].insertNotification(element);
